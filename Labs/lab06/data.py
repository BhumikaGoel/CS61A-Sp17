...
cale = Character('Cale',
                  'Hilfinger went to Soda to start grading. You can find him there.')
hilfinger = Character('Hilfinger',
...
# Things:
wallet = Thing('Wallet',
               "Looks like Hilfinger's wallet. We should return it to him.")
hotdog = Thing('Hotdog',
